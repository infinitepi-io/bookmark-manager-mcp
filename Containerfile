...
LABEL usage.podman="podman run -v ~/.data:/app/.data mindriftfall2infinitepiio/bookmark-manager-mcp:latest"
LABEL usage.docker="docker run -v ~/.data:/app/.data mindriftfall2infinitepiio/bookmark-manager-mcp:latest"
